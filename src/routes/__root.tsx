    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-input bg-background px-5 py-2.5 text-sm font-semibold hover:bg-accent"
          >
            Go home
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#EF80B2" },
      { title: "YLYTO — Mode enfant marocaine premium" },
      {
        name: "description",
        content:
          "YLYTO, marque marocaine de vêtements pour enfants : douceur, couleurs joyeuses et confort. Découvrez la nouvelle collection.",
      },
      { property: "og:title", content: "YLYTO — Mode enfant marocaine premium" },
      {
        property: "og:description",
        content: "Vêtements pour enfants pensés au Maroc, avec amour. Nouvelle collection disponible.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "https://cdn.ylyto.ma/ylyto/Logo%20YLYTO.png" },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Caveat+Brush&family=Caveat:wght@500;700&family=Quicksand:wght@400;500;600;700&family=Lalezar&family=Tajawal:wght@400;500;700&display=swap",
      },
    ],
  }),
